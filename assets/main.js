...
function applyTheme(theme) {
  ...
  document.querySelectorAll('.theme-toggle').forEach(btn => {
    btn.innerHTML = resolved === 'dark' ? sunIcon() : moonIcon();
